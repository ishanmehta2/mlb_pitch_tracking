#!/usr/bin/env python
# train_3dcnn_pitch.py
# -------------------------------------------------------------
#  Proof-of-concept: 3-D CNN for baseball-pitch classification
# -------------------------------------------------------------
#  • Python ≥3.10 • PyTorch ≥2.2 • TorchVision ≥0.18
#  Dataset CSV format:
#       /abs/path/to/video_001.mp4,fastball
#       /abs/path/to/video_002.mp4,slider
#  Labels are mapped to integers on the fly.
# -------------------------------------------------------------
...
def train_one_epoch(model, loader, criterion, optim, scaler, device):
    ...
    for clips, labels in loader:
        ...
        labels = torch.as_tensor(labels, device=device)  # <— safe conversion
...
def main(args):
    warnings.filterwarnings("ignore", category=UserWarning)  # silence av warnings
